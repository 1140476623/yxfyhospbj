...
public class ReturnFormat {
    ...
    public static String retParam(int status, Object data, String exMsg) {
        OutputJson json = new OutputJson(status, messageMap.get(String.valueOf(status)), exMsg, data);
