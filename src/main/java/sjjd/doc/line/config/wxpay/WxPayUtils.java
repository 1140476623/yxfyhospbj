...
public class WxPayUtils {
    ...
    public static String getStreamString(InputStream inputStream) throws Exception {
        ...
        try {
            inputStreamReader = new InputStreamReader(inputStream, WxPayConstants.DEFAULT_CHARSET);
    ...
    public static String getSignature(final Map<String, String> data, String key, String signType) throws Exception {
        ...
        if (signType.equals(WxPayConstants.SING_MD5)) {
            return MD5(sb.toString()).toUpperCase();
        } else if (signType.equals(WxPayConstants.SING_HMACSHA256)) {
    ...
    public static Map<String, String> processResponseXml(String xmlStr, String signType) throws Exception {
        String RETURN_CODE = WxPayConstants.RETURN_CODE;
        String return_code;
    ...
    private static boolean isResponseSignatureValid(final Map<String, String> reqData, String signType) throws Exception {
        ...
        return isSignatureValid(reqData, WxPayConfig.key, signType);
    }
    ...
    public static Map<String, String> requestToMap(HttpServletRequest request) {
        ...
        while (parameterNames.hasMoreElements()) {
            ...
            paramResultMap.put(paramName, paramValue);
        }
        System.out.println(paramResultMap);
